...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "projects-fly-poison",
          title: 'Fly Poison',
          description: "Sugar feeding on a toxic plant.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/1_project.html";
            },},{id: "projects-life-history-of-blood-feeding",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%61%6D%65%73%6D%6F%6C%6F%6E%65%79%76%69@%76%74.%65%64%75", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
